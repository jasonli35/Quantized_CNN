...
def Quantconv3x3(in_planes, out_planes, stride=1, **kwargs):
...
class ResNet_Cifar(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, float=False, **kwargs):
        downsample = None
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, float=float, **kwargs))
        self.inplanes = planes * block.expansion
        for _ in range(1, blocks):
            layers.append(block(self.inplanes, planes, float=float, **kwargs))
